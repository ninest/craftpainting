...
parser.add_argument('-s', '--size', default=10, help='the painting output size')
parser.add_argument('-g', '--gray', default=False, action='store_true', help='true/false depending on whether the output painting should be black and white')
